...
# instal stringer first to use str_detect 

filtered_data <- selected_data %>%
  filter(!(Samp_ID %in% c("Atropine", "Bypass", "Blank","Apple leaf"))) %>%
  filter(!(Samp_ID %in% c("Oregano 1", "Oregano 2", "Oregano 3", "Oregano 4", "Oregano 5", "Oregano 6", "Oregano 7", "Apple leaves", "apple leaf"))) %>%
